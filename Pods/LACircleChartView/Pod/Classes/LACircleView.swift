...
public class LACircleView: UIView {
    ...
    override public func drawRect(rect: CGRect) {
        ...
        //adjust stroke width
        let radiusAndStroke = getRadiusAndStrokeWidth(rect)
        ...
        CGContextSetLineCap(context,isRectCap ? .Square : .Round)
    ...
    override public func layoutSubviews() {
        ...
        circleLayer.lineWidth = getRadiusAndStrokeWidth(rect).strokeWidth
    ...
    func getRadiusAndStrokeWidth(rect:CGRect) -> (strokeWidth : CGFloat, radius :CGFloat ){
        ...
        return (strokeWidth,getRadius(rect,stroke: strokeWidth))
    ...
    func updateArrow(){
        let strokeAndRadius = getRadiusAndStrokeWidth(self.bounds)
